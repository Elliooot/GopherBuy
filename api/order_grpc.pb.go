...
const (
	...
	OrderService_CreateFlashSale_FullMethodName  = "/api.OrderService/CreateFlashSale"
)
...
type OrderServiceClient interface {
	CreateFlashOrder(ctx context.Context, in *FlashOrderRequest, opts ...grpc.CallOption) (*CreateOrderResponse, error)
	CreateOrder(ctx context.Context, in *OrderRequest, opts ...grpc.CallOption) (*CreateOrderResponse, error)
...
func (c *orderServiceClient) CreateFlashOrder(ctx context.Context, in *FlashOrderRequest, opts ...grpc.CallOption) (*CreateOrderResponse, error) {
...
func (c *orderServiceClient) CreateOrder(ctx context.Context, in *OrderRequest, opts ...grpc.CallOption) (*CreateOrderResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateOrderResponse)
...
func (c *orderServiceClient) CreateFlashSale(ctx context.Context, in *CreateFlashSaleRequest, opts ...grpc.CallOption) (*CreateFlashSaleResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateFlashSaleResponse)
	err := c.cc.Invoke(ctx, OrderService_CreateFlashSale_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderServiceServer interface {
	CreateFlashOrder(context.Context, *FlashOrderRequest) (*CreateOrderResponse, error)
	CreateOrder(context.Context, *OrderRequest) (*CreateOrderResponse, error)
...
func (UnimplementedOrderServiceServer) CreateFlashOrder(context.Context, *FlashOrderRequest) (*CreateOrderResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateFlashOrder not implemented")
}
func (UnimplementedOrderServiceServer) CreateOrder(context.Context, *OrderRequest) (*CreateOrderResponse, error) {
...
func (UnimplementedOrderServiceServer) CreateFlashSale(context.Context, *CreateFlashSaleRequest) (*CreateFlashSaleResponse, error) {
...
func _OrderService_CreateFlashSale_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateFlashSaleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServiceServer).CreateFlashSale(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrderService_CreateFlashSale_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).CreateFlashSale(ctx, req.(*CreateFlashSaleRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var OrderService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _OrderService_CreateFlashSale_Handler,
		},
	},
